...
channel_for_data  = UnreliableChannel(env=env,name="DATA_CHANNEL",Pc=0.5, Pl=0,propagation_delay=2, transmission_rate=1000)
channel_for_ack	  = UnreliableChannel(env=env,name="ACK_CHANNEL", Pc=0.5, Pl=0,propagation_delay=2, transmission_rate=1000)
